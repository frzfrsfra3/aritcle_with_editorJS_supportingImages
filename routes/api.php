...
Route::get("{post}", "PostsController@show2")->name("api.posts.show2");
Route::get("{category}/{post}", "PostsController@show")->name("api.posts.show");
Route::post("uploadfile","PostsController@upload");

Route::post("nomagic","PostsController@nomagic");
Route::post("nomagic2","PostsController@nomagic2");
/*
    |--------------------------------------------------------------------------
    | Comments routes
    |--------------------------------------------------------------------------
