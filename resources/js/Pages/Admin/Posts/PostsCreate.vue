    ...
    <div class="container-fluid">
        <form action="" @submit.prevent="post">
            ...
            <div class="form-group">
                ...
                <new-editor @custom-change="onClickChild" @clicked="onClickChild" v-model="form.content" @value="form.content" id="content" ></new-editor>
...
<script>
    ...
    export default {
        components: {CoverUploader, MarkdownEditor, InputTag, NewEditor },
