<template>
  <div >
    ...
    <button style="margin-left: 30%;" type="button" id="ss" name="button" @click="save()">save</button>
    <div class="editorx_body">
    ...
    <div id="m01" class="modal">
        ...
        <!-- <gify></gify> -->
         ...
         <input v-model="searchTerm" :keyup.enter="getGifs()" placeholder="Search Gif" type="text">
  ...
  methods: {
    save: function() {
      ...
      console.log(savedData.blocks);
        this.$emit('clicked', savedData);
       this.preview= this.convertDataToHtml(savedData.blocks);
       this.$emit('value', savedData.blocks);
    ...
    myEditor: function() {
      ...
      config: {
        endpoints: {
          ...
          byUrl: '/api/nomagic2', // Your endpoint that provides uploading by Url
        },
        //     uploader: {
        //   /**
...
// this.save2();
  editor.save().then(savedData => {
        console.log(savedData);
      console.log(savedData.blocks);
    //    this.$emit("customChange",savedData);
    //   this.$emit('clicked', savedData);
    //    this.preview= this.convertDataToHtml(savedData.blocks);
    //    this.$emit('value', savedData.blocks);
        // this.save2();
