...
<template>
	...
	@click="clickme(element)" class="modal-hover-opacity">
  </div>
  <div class="container1">
  ...
  <div class="container1">
    <img src="http://www.filmosphere.com/wp-content/uploads/2013/04/Iron-Man-3-affiche1-300x400.jpg" style="max-width:100%;cursor:pointer" @click="clickme(element)" class="modal-hover-opacity">
  </div>
...
<script>
  ...
  document.getElementById("modal01").style.display = "block";
        ...
        mounted(){
            $($('.cover_label')[0]).on('click', function()
                {
                $("#addNew").modal("show");
                });
        }
